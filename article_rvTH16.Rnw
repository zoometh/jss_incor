...
\smallbreak
<<a_r_t, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center",fig.asp=0.1, fig.width=10, fig.cap="\\label{fig:fart}Concatenate of 'a', 'r' and 't' graphical units is 'art'">>=
...
<<echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=2, fig.height=2, fig.cap="\\label{fig:fratar}Potential spatial relations between graphical units">>=
par(mar=c(0.1,0.1,0.1,0.1) )
...
% \begin{center}
\centering
\begin{tabular}{|p{.6cm} p{.5cm} p{.6cm} p{2cm} p{2cm} p{5cm}|}
\hline
...
%
<<timg, echo=TRUE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=18, fig.height=13, fig.cap="\\label{fig:dataset}Decoration images of the training dataset">>=
# library("magick")
...
<<igraphs, echo=TRUE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=4, fig.cap="\\label{fig:igraph}R interface. Plot of the first graph of the list">>=
