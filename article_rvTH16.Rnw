...
\smallbreak
<<a_r_t, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", out.height="50%", fig.cap="\\label{fig:figs}Concatenate of 'a', 'r' and 't' graphical units is 'art'">>=
...
\begin{figure}[H] 
\centering
\includegraphics[height=10cm, keepaspectratio]{gis_1}
...
\begin{figure}[H] 
\centering
\includegraphics[height=10cm, keepaspectratio]{gis_2}
