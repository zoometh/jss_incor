...
\smallbreak
<<a_r_t, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=3, fig.cap="\\label{fig:figs}Concatenate of 'a', 'r' and 't' graphical units is 'art'">>=
...
<<igraph, echo=TRUE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=4, fig.cap="\\label{fig:figs}R interface. Plot of the first graph of the list">>=
...
<<tr_st, echo=TRUE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=4, fig.asp=1, fig.cap="\\label{fig:figs}Torrejon Rubio 1 decoration">>=
# library("decorr")
par(mar=c(0,0,0,0))
sit <- "Torrejon Rubio" ; dec <- "Torrejon Rubio 1"
...
<<results='asis', echo=TRUE>>=
df.same_edges <- same_neds(lgrph, "type", "edges")
...
df.same_edges <- same_neds(lgrph, "type", "edges")
df.same_nodes<- same_neds(lgrph, "type", "nodes")
# library("xtable")
