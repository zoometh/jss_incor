...
\caption{\label{fig:figs}Decoration images of the training dataset}\label{fig:unnamed-chunk-5}
\end{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(e, x, parent.frame()): object 'decor' not found}}\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cat(as.numeric(cm.1), "{};"{}, as.numeric(cm.8)): object 'cm.1' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in igraph::graph\_from\_data\_frame(g.edges, directed = FALSE, vertices = g.nodes): the data frame should contain at least two columns}}\begin{verbatim}
R> plot(lgrph[[1]],
+       vertex.color = "orange",
...
\caption{\label{fig:figs}Torrejon Rubio 1 decoration}\label{fig:unnamed-chunk-11}
\end{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(lgrph, function(x) x\$name): object 'lgrph' not found}}\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(decor.A = c(g.compar[[1]][[1]]\$decor, g.compar[[2]][[1]]\$decor, : object 'g.compar' not found}}\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xtable::xtable(df.edges.compar, caption = "{}Pairwise comparisons dataframe between decor.A and decor.B"{}, : object 'df.edges.compar' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(lgrph, function(x) x\$name): object 'lgrph' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_nds\_compar(g.compar, c(3, 4), doss = system.file("{}extdata"{}, : object 'g.compar' not found}}\begin{verbatim}
