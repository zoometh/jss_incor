...
pth <- system.file("extdata", package = "iconr")
lims <- list()
...
nds.df <- read_nds(site = sit, decor = dec, dev = ".shp",
                   doss = system.file("extdata", package = "iconr"))
