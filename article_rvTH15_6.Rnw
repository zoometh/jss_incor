...
\smallbreak
<<echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=10, fig.height=5, fig.cap="\\label{fig:figs}Concatenate of 'a', 'r' and 't' graphical units is 'art'">>=
# par(mar=c(0,0,0,0))
...
<<igraph, echo=TRUE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=4, fig.height=4, fig.cap="\\label{fig:figs}R interface. Plot of the first graph of the list">>=
# par(mar=c(0.1,0.1,0.1,0.1))
# library("decorr")
# library("magick")
# imgs <- read.table(system.file("extdata", "imgs.tsv", package = "decorr"),
...
<<tr_st, echo=TRUE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", fig.width=3, fig.cap="\\label{fig:figs}Torrejon Rubio 1 decoration">>=
# library("decorr")
par(mar=c(0,0,0,0))
sit <- "Torrejon Rubio" ; dec <- "Torrejon Rubio 1"
